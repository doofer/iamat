...
use Doofer\IamatBundle\Entity\Location;
use Doofer\IamatBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DooferIamatBundle:Location')->findAll();
     ...
     * @Method("POST")
     * @Template("DooferIamatBundle:Location:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DooferIamatBundle:Location')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DooferIamatBundle:Location:edit.html.twig")
     */
